...
\begin{tabular}{|p{4cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}|}
    ...
    \makecell[l]{M\\ \scriptsize  With unauthorized access, an attacker could corrupt or wipe the data stored on the SSD, rendering it inaccessible.\\\scriptsize (\cite{nistsp80060v1r1} 4.4.2.3)} \\\hline
    
    % AeroTech Flight Software
    \makecell{AeroTech Flight\\ Software} & 
    \makecell[l]{M\\ \scriptsize  The flight software include proprietary and sensitive information within, this can lead to serious breaches in confidentiality if our adversaries copy or use our techniques.\\ \scriptsize (\cite{nistsp80060v1r1} 4.2.2.1)} & 
